        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
            ...
            <div>
                ...
                <p class="text-muted mb-0">
                    Add a new package size and inventory option for
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="name" name="name" value="{{ old('name') }}"
                                    class="form-control @error('name') is-invalid @enderror" placeholder="e.g. 500g"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" id="sku" name="sku" value="{{ old('sku') }}"
                                        class="form-control @error('sku') is-invalid @enderror" placeholder="e.g. ALM-500"
                                        maxlength="100" required>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" id="weight_grams" name="weight_grams"
                                            ...
                                            max="100000" placeholder="500" required>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <small class="text-muted">
                                        Admin will see a low-stock warning at this quantity.
                                    </small>
