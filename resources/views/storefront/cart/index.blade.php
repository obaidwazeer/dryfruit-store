                ...
                <div class="row g-4 align-items-start">
                            ...
                            @foreach ($cart as $item)
                                ...
                                <article class="storefront-cart-item">
                                    ...
                                    <div class="storefront-cart-quantity">
                                        ...
                                        <form method="POST"
                                            action="{{ route('storefront.cart.update', $item['variant_id']) }}">
                                            ...
                                            <div class="storefront-quantity-control">
                                                ...
                                                <input type="number" name="quantity" value="{{ $item['quantity'] }}"
                                                    min="1" max="{{ $item['stock'] }}" aria-label="Quantity">
                                    ...
                                    <div class="storefront-cart-remove">
                                        ...
                                        <form method="POST"
                                            action="{{ route('storefront.cart.destroy', $item['variant_id']) }}">
                    ...
                    <div class="col-lg-4">
                        ...
                        <aside class="storefront-cart-summary">
                            ...
                            <a href="#" class="btn btn-storefront-primary storefront-checkout-button">
                                Proceed to Checkout
                                <i class="bi bi-arrow-right ms-2"></i>
                            </a>
